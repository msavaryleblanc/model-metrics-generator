...
public class InterfaceRealizationElement extends PackagedElement {


    public InterfaceRealizationElement(Node node) {
        super(node);

        DiagElementCSVEntry classCSVEntry = new DiagElementCSVEntry();
        classCSVEntry.setElementId(this.id);
        classCSVEntry.setElementType("interface_realization");

...
public class InstanceSpecificationElement extends PackagedElement {


    public InstanceSpecificationElement(Node node) {
        super(node);

        DiagElementCSVEntry classCSVEntry = new DiagElementCSVEntry();
        classCSVEntry.setElementId(this.id);
        classCSVEntry.setElementType("instance_specification");
